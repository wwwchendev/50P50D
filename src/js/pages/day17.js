...
import '../../stylesheet/page/_day17.scss';
...
//   (3) ✔️DISCOVER Movie|使用30多個過濾器和排序選項來尋找​​電影
...
const day17 = () => {
  projectSlider(17);
  const APIKey = `c3c2d9ae238383f2129b4e9b63d11953`;
  const API_URL = `https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=${APIKey}&page=1&language=zh-TW`;
